// define Level4 state and methods
...
Level4.prototype = {
	preload: function() {
		...
		game.load.image('Level4', 'assets/img/background4-01.png');
		game.load.image('platform', 'assets/img/platform.png');
		game.load.image('dandelion', 'assets/img/dandelion.png');
	},
	create: function() {

		var background = game.add.tileSprite(0, 0, 2048, 1024, 'Level4');
		game.world.setBounds(0, 0, 2048, 1024);

		var yPos = game.world.height-200;

		//function Player(game, index, sprite, velocityY, region, gravity, x, y, skyLevel) {
		player = new Player(game, 'mouse', 'mouse01', 0, 'ground', 800, game.world.width/2, game.world.height-300, 1); //why does it think the player health is 1 and not 0?
